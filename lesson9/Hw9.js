...
// - Є масив   // Для кожного елементу масиву зробити блок в якому
...
//
// let coursInformation = document.createElement('div');
// document.body.appendChild(coursInformation);
// let h = document.createElement('h');
// h.innerText = `${element.title} - ${element.monthDuration}`
//     coursInformation.appendChild(h) ;
// }
// =========================
//     - Є масив
...
//
//     let p = document.createElement('p');
//     p.innerHTML = `${simpson.name}   ${simpson.surname}  ${simpson.age}  ${simpson.info} `;
//     p.src = `${simpson.photo}`;
//
...
p2.innerHTML = ` monthDuration -${element.monthDuration}; hourDuration-${element.hourDuration}`;
div.append(h3,p2);
